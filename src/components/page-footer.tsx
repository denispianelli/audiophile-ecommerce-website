...
export default function Footer() {
  return (
    <footer className="bg-footer relative w-screen md:px-10">
      ...
      <div className="xl:mx-auto xl:w-[1110px]">
        <div className="xl:flex xl:items-end xl:justify-between">
          <p className="text-body mb-12 px-6 text-center text-white/50 md:mb-20 md:px-0 md:text-start xl:mb-0 xl:w-[540px]">
            Audiophile is an all in one stop to fulfill your audio needs.
            We&apos;re a small team of music lovers and sound specialists who
            are devoted to helping you get the most out of personal audio. Come
            and visit our demo facility - we’re open 7 days a week.
          </p>
          <ul className="hidden items-center justify-center gap-4 xl:flex">
        ...
        <div className="items-center  justify-between md:flex md:pb-[46px]">
          <p className="text-body text-center font-bold text-white/50 xl:mt-[56px]">
            Copyright 2024. All Rights Reserved
          </p>
          <ul className="mt-[48px] flex items-center justify-center gap-4 pb-[38px] md:m-0 md:p-0 xl:hidden">
            <li className="hover:text-primary">
              <Link href="#">
                <svg
                  className="group"
